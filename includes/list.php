	...
	foreach($r as $row){
		...
		<tr class="alternate">
			...
			<td class="title column-title">
				<strong>
					<a class="row-title" href="<?php echo esc_url( add_query_arg( array( 'psfbid' => $row->ID ), menu_page_url( 'ps-form-builder-new', false ) ) ); ?>" title="<?php echo __('Edit','psfbldr').' '.esc_attr($row->post_title).''; ?>">
						<?php 
			...
			<td class="shortcode column-shortcode">
				<input type="text" onfocus="this.select();" onmouseup="return false;" readonly="readonly" value="[psfb id=&quot;<?php echo $row->ID; ?>&quot; title=&quot;<?php echo esc_attr($row->post_title); ?>&quot;]" class="shortcode-in-list-table wp-ui-text-highlight code form-control" style="cursor:text;color:#32373c;">
			</td>
